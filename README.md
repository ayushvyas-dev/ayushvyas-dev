...
<p align="center">
  <em>Backend-Focused Full-Stack Developer · Building scalable systems and real-world products</em>
</p>
...
- 🎓 BTech Computer Science student at **MAIT, Delhi**
- 💻 Interested in **backend engineering, scalable systems & full-stack development**
- 🏗️ Currently building production-style applications with **Node.js, TypeScript, PostgreSQL & Next.js**
- 🧠 Interested in **system design, authentication, authorization, databases, APIs & distributed backend systems**
- 🤖 Exploring **AI engineering** and building practical AI-powered applications
...
### 🔐 [Team Access Control API](https://github.com/ayushvyas-dev/team-access-control-api)

> A production-style backend API for managing organizations, teams, memberships and permissions.

Built as a **modular monolith** with a strong focus on backend architecture, security and scalability.
...
- 🛡️ Role-Based Access Control with permission-based authorization
- ✉️ Organization invitations with expiry and status tracking
- 📝 Transactional audit logging for important organization actions
- ⚡ Redis-backed rate limiting
- 📬 BullMQ background jobs for asynchronous email delivery
- 🗄️ PostgreSQL with Prisma ORM and database migrations
- 📚 OpenAPI / Swagger API documentation
- 🧪 Unit & integration testing
- 🐳 Docker-based deployment planned on **AWS EC2**

**Stack:** Node.js · TypeScript · Express · PostgreSQL · Prisma · Redis · BullMQ · JWT · Zod · Docker · AWS

[![Source Code](https://img.shields.io/badge/Source_Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/ayushvyas-dev/team-access-control-api)

---

### 🤖 AI Job Application Mate
...
**Stack:** Next.js · React · TypeScript · AI/LLM APIs · Node.js

[![Source Code](https://img.shields.io/badge/Source_Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/ayushvyas-dev)
...
- 📋 Add and manage subscriptions with different billing cycles
- 📅 Track subscription renewals
- 🗄️ MongoDB Atlas for persistent data
- 🌐 Deployed on Vercel

**Stack:** Next.js · MongoDB · Mongoose · NextAuth.js · Tailwind CSS
...
<p align="center">
  <i>Building systems, breaking things, learning how they work, and getting better every day.</i>
</p>
